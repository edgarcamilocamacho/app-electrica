...
| Nivel | Resultado |
|---|---|
| Unitarias + integración (Vitest) | **210 / 210** |
...
- **A igual calibre, el color de un borne lo pone el cable que va primero en el documento** [Técnica]:
  el orden de creación no se guarda (los ids son aleatorios), así que «el primero que se conectó» se
  aproxima con un orden fijo; siempre elige el mismo.
- **El DOM dice qué bornes están iluminados** [Técnica]: cada aparato lleva `data-lit` con la lista
  de bornes con luz, para verificarlo en E2E sin capturas.
